  ...
  return (
    <Fragment>
      {location.pathname !== "/checkout" ? (
        <div className="cart-dropdown" style={!visibility ? {display:"none"}:null}>
          <img onClick={handleVisibility} src={cartArrowClose} alt="close arrow" className="closeCartArrow" role="button"/>
